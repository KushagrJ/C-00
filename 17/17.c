 ...
 * scanf() only reads the user input after it's been called and before the enter key has been pressed. So, the actual position of the entered value (i.e. on top of the underscores) doesn't affect scanf().
