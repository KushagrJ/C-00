...
int main(void)
{
    ...
    printf("%f, %f and %Lf can also be written as %e/%E, %e/%E and %Le/%LE in the standard form, or as %a/%A, %a/%A and %La/%LA in the hexadecimal form, respectively.\n", a, b, c, a, a, b, b, c, c, a, a, b, b, c, c);
 ...
 * %g/%G prints a value as either %f/%F or %e/%E, depending upon the value converted and the precision. Also, it removes any trailing zeroes from the fractional portion of the result.
 */