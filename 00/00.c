...
/*
 * #include <stdio.h> tells the compiler to include information found in the file stdio.h, which provides support for keyboard input & for displaying output, printf(), etc.
 ...
 * int is a C keyword identifying one of the basic C data types. For example, int can't be used as the name of a function or a variable.
 */